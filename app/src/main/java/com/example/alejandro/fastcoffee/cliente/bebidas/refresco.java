...
public class refresco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaentradas = Arrays.asList(new entradasRv(R.drawable.ref, "Refrescos","", "39"),
                new entradasRv(R.drawable.agua, "Agua embotellada","", "18"),
                new entradasRv(R.drawable.cerveza, "Cerveza","", "23"),
                new entradasRv(R.drawable.cubcer, "Cubeta c/10 cervezas","", "200"),
                new entradasRv(R.drawable.copavin, "Copa de vino","", "45"),
                new entradasRv(R.drawable.botvin, "Botella de vino","", "190"));
        ...
        adaptador.setOnClickListener(new View.OnClickListener() {
            ...
            private void confirmarOrden() {
                AlertDialog.Builder dialogo1 = new AlertDialog.Builder(refresco.this);
            ...
            private void registrarOrden(){
                ...
                ConexionSQLiteHelper conn=new ConexionSQLiteHelper(refresco.this, "bd_orden",null,1);
                ...
                Intent intent = new Intent(refresco.this, Cuenta.class);
