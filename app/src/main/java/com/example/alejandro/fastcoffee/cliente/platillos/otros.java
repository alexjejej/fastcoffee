...
public class otros extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaentradas = Arrays.asList(new entradasRv(R.drawable.galletas, "Galletas","", "12"),
                new entradasRv(R.drawable.pastel, "Rebanada de Pastel","","45"),
                new entradasRv(R.drawable.brownie, "Brownie con Helado","","45"),
                new entradasRv(R.drawable.helado, "Copa de Helado","(Con tres bolas)","40"));
        ...
        adaptador.setOnClickListener(new View.OnClickListener() {
            ...
            private void confirmarOrden() {
                AlertDialog.Builder dialogo1 = new AlertDialog.Builder(otros.this);
            ...
            private void registrarOrden(){
                ...
                ConexionSQLiteHelper conn=new ConexionSQLiteHelper(otros.this, "bd_orden",null,1);
                ...
                Intent intent = new Intent(otros.this, Cuenta.class);
