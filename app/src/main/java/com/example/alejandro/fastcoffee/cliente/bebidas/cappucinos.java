...
public class cappucinos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capu);
        ...
        listaentradas = Arrays.asList(new entradasRv(R.drawable.caputra, "Cappucino tradicional","", "39"),
                new entradasRv(R.drawable.capumoka, "Cappucino moka","", "39"),
                new entradasRv(R.drawable.capufran, "Cappucino vainilla Francesa","", "39"),
                new entradasRv(R.drawable.capucrema, "Cappucino crema Irlandesa","", "39"),
                new entradasRv(R.drawable.capucar, "Cappucino caramelo","", "39"),
                new entradasRv(R.drawable.caputira, "Cappucino Tiramisu","", "39"),
                new entradasRv(R.drawable.capurom, "Cappucino rompope Italiano","", "39"),
                new entradasRv(R.drawable.capucaj, "Cappucino cajeta","", "39"),
                new entradasRv(R.drawable.capuamar, "Cappucino Amaretto","", "39"),
                new entradasRv(R.drawable.capucho, "Cappucino chocolate Macadamia","", "39"));
        ...
        adaptador.setOnClickListener(new View.OnClickListener() {
            ...
            private void confirmarOrden() {
                AlertDialog.Builder dialogo1 = new AlertDialog.Builder(cappucinos.this);
            ...
            private void registrarOrden(){
                ...
                ConexionSQLiteHelper conn=new ConexionSQLiteHelper(cappucinos.this, "bd_orden",null,1);
                ...
                Intent intent = new Intent(cappucinos.this, Cuenta.class);
