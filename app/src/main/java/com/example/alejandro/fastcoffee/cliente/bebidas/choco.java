...
public class choco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaentradas = Arrays.asList(new entradasRv(R.drawable.chotra, "Chocolate tradicional","", "39"),
                new entradasRv(R.drawable.choblan, "Chocolate Blanco","", "39"));
        ...
        adaptador.setOnClickListener(new View.OnClickListener() {
            ...
            private void confirmarOrden() {
                AlertDialog.Builder dialogo1 = new AlertDialog.Builder(choco.this);
            ...
            private void registrarOrden(){
                ...
                ConexionSQLiteHelper conn=new ConexionSQLiteHelper(choco.this, "bd_orden",null,1);
                ...
                Intent intent = new Intent(choco.this, Cuenta.class);
