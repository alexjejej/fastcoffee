...
public class crepasdulces extends AppCompatActivity {
    RecyclerView rv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crepasdulces);
        ...
        listaentradas = Arrays.asList(new entradasRv(R.drawable.crepale, "Crepa de Lechera","", "40"),
                new entradasRv(R.drawable.crepamer, "Crepa de Mermelada","", "40"),
                new entradasRv(R.drawable.crepacaj, "Crepa de Cajeta","", "40"),
                new entradasRv(R.drawable.crepalm, "Crepa de Lechera con Zarzamora","", "45"),
                new entradasRv(R.drawable.crepaqz, "Crepa de Queso crema y Zarzamora","", "45"),
                new entradasRv(R.drawable.crepanut, "Crepa de Nutella","", "45"),
                new entradasRv(R.drawable.crepasupreme, "Crepa Chocolate Supremo","(Con nutella, fresas naturales, trozos de nuez, salsa de chocolate y helado de chocolate)","70"),
                new entradasRv(R.drawable.crepapar, "Crepa Paraíso Frutal","(Con queso crema, mermelada de zarzamora, fresa, kiwi, trozos de nuez, lechera y helado de vainilla)","70"),
                new entradasRv(R.drawable.crepaten, "Crepa Dulce Tentación","(Con queso crema, cajeta, platano, trozos de nuez, lechera y helado de vainilla)","70"));
        ...
        adaptador.setOnClickListener(new View.OnClickListener() {
            ...
            private void confirmarOrden() {
                AlertDialog.Builder dialogo1 = new AlertDialog.Builder(crepasdulces.this);
            ...
            private void registrarOrden(){
                ...
                ConexionSQLiteHelper conn=new ConexionSQLiteHelper(crepasdulces.this, "bd_orden",null,1);
                ...
                Intent intent = new Intent(crepasdulces.this, Cuenta.class);
