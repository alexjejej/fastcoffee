...
public class SodasItalianas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sodas_italianas);
        ...
        listaentradas = Arrays.asList(new entradasRv(R.drawable.sodamanzanaverde, "Soda Italiana de manzana verde","Soda Italiana sabor manzana", "40"),
                new entradasRv(R.drawable.sodaitalianafrutadelapasion, "Soda Italiana de fruta de la pasión","Soda Italiana hecha con fruta de la pasión(Maracuyá)", "40"),
                new entradasRv(R.drawable.sodaitalianamango, "Soda Italiana de mango","Soda Italiana sabor mango","40"));
        ...
        adaptador.setOnClickListener(new View.OnClickListener() {
            ...
            private void confirmarOrden() {
                AlertDialog.Builder dialogo1 = new AlertDialog.Builder(SodasItalianas.this);
            ...
            private void registrarOrden(){
                ...
                ConexionSQLiteHelper conn=new ConexionSQLiteHelper(SodasItalianas.this, "bd_orden",null,1);
                ...
                Intent intent = new Intent(SodasItalianas.this, Cuenta.class);
