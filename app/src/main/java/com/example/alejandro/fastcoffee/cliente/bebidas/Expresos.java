...
public class Expresos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaentradas = Arrays.asList(new entradasRv(R.drawable.cafesen, "Expreso sencillo","", "20"),
                new entradasRv(R.drawable.cafedob, "Expreso doble","", "23"),
                new entradasRv(R.drawable.cafeamericano, "Expreso Americano","","23"),
                new entradasRv(R.drawable.cafeaffogato, "Expreso Affogato","", "30"));
        ...
        adaptador.setOnClickListener(new View.OnClickListener() {
            ...
            private void confirmarOrden() {
                AlertDialog.Builder dialogo1 = new AlertDialog.Builder(Expresos.this);
            ...
            private void registrarOrden(){
                ...
                ConexionSQLiteHelper conn=new ConexionSQLiteHelper(Expresos.this, "bd_orden",null,1);
                ...
                Intent intent = new Intent(Expresos.this, Cuenta.class);
