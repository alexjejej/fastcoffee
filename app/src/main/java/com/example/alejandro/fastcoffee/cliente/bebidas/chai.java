...
public class chai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaentradas = Arrays.asList(new entradasRv(R.drawable.chaivai, "Chai vainilla","", "39"),
                new entradasRv(R.drawable.chaimango, "Chai mango","", "39"));
        ...
        adaptador.setOnClickListener(new View.OnClickListener() {
            ...
            private void confirmarOrden() {
                AlertDialog.Builder dialogo1 = new AlertDialog.Builder(chai.this);
            ...
            private void registrarOrden(){
                ...
                ConexionSQLiteHelper conn=new ConexionSQLiteHelper(chai.this, "bd_orden",null,1);
                ...
                Intent intent = new Intent(chai.this, Cuenta.class);
